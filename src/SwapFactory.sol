...
contract SwapFactory {
    ...
    function adjustBase() external {
        ...
        require(!baseAdjusted[currentEpoch]);
        ...
        executorCost = baseExecutorCost * base / 100;
        interactionCost = baseInteractionCost * base / 100;
    ...
    function purchaseInteractionPermission() external {
        fundsForTreasury += treasuryCut * interactionCost / 100;
        uint256 currentEpoch = (block.timestamp - startTime) / epochLength;
